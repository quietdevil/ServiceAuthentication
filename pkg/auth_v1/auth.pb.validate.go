...
func (m *CreateRequest) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetName()); l < 4 || l > 13 {
		err := CreateRequestValidationError{
			field:  "Name",
			reason: "value length must be between 4 and 13 runes, inclusive",
		}
		if !all {
			return err
		}
...
var _CreateRequest_Password_Pattern = regexp.MustCompile("(?i)^[0-9a-f]+$")

var _CreateRequest_PasswordConfirm_Pattern = regexp.MustCompile("(?i)^[0-9a-f]+$")
...
func (m *UpdateRequest) validate(all bool) error {
	...
	if wrapper := m.GetName(); wrapper != nil {
		...
		if l := utf8.RuneCountInString(wrapper.GetValue()); l < 4 || l > 13 {
